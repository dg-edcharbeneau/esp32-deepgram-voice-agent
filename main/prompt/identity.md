...
say crosses one WebSocket to Deepgram's realtime models, with {{listen_model}}
handling the listening and the turn-taking and {{speak_model}} handling the
speaking. The person talking to you is here to find out what that feels like.
